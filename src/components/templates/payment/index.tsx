...
export const PaymentTemplate: FC<CategoryTemplateProps> = ({
  ...
  return (
    <Fragment> <Box component="form"
      ...
      <Autocomplete
        ...
        renderOption={
          (props, option, { selected }) => {
            ...
            return <li {...props} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", maxWidth: 500, padding: 4 }}>
      ...
      <Button sx={{ minWidth: 100 }} variant="contained" onClick={handleUpdate}>{t("common.register")}</Button></Fragment>
  );
};
